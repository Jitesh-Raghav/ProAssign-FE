    ...
    <>
      <div className="relative px-5 lg:px-0 lg:flex gap-5 justify-center py-5">
        ...
        <section className="w-full lg:w-[48rem]">
          <div className="flex gap-2 items-center pb-5 justify-start">
          <p className="ml-2">Search</p>
          <YoutubeSearchedForIcon/>
            <div className="relative p-0 w-full justify-start">
              
              {/* Replace the existing Input component with PlaceholdersAndVanishInput */}
          ...
          <div>
            ...
            {project.projects.length > 0 ? (
              <div>
                {/* Pagination component can be uncommented here */}
              </div>
            ) : (
              <div className="flex items-center justify-start h-[-20vh]">
